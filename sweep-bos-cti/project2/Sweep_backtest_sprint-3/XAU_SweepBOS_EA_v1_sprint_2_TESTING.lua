...
// === GLOBAL OVERRIDES (đồng bộ input/preset với log) ===
...
// Detection settings with CORRECTED pip display
   double eqTolPips = (pipSize > 0.0) ? P.EqTol / pipSize : 0.0;
...
// SUMMARY STATS (requested by user)
   ...
   summary += "AvgR=" + DoubleToString((stats.avgLoss != 0.0) ? (stats.avgWin / MathAbs(stats.avgLoss)) : 0.0, 2) + ", ";
