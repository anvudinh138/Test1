// === XAU_SweepBOS_EA_v1_final_sprint_1.mq5 ===
// Baseline presets 1..26 + winners remapped contiguously to 27..31
// Mapping: 27<-36, 28<-37, 29<-41, 30<-45, 31<-46
// ----------------------------------------------------------------
//+------------------------------------------------------------------+
//|                                                XAU_SweepBOS_Demo |
...
case 28: // MAPPING-> original 37 (block not found)
...
case 29: // MAPPING-> original 41 (block not found)
...
case 30: // MAPPING-> original 45 (block not found)
...
case 31: // MAPPING-> original 46 (block not found)
...
// Additional presets (128-130) - moved to separate function
bool ApplyPresetBuiltInExtended(int id)
  {
   UseInputsAsParams();
   switch(id)
     {
...
bool SetupParamsFromPreset()
  {
   ...
   if(UsePreset)
     {
      if(PresetID >= 128 && PresetID <= 130)
         ok = ApplyPresetBuiltInExtended(PresetID);
      else
