// === XAU_SweepBOS_EA_v1_final_26.mq5 ===
// Contains 26 curated presets mapped to IDs 1..26.
// Usecase 27+ reserved for future experiments.
// Mapping table provided in XAU_SweepBOS_v1_final_26_mapping.csv
//+------------------------------------------------------------------+
//|                                                XAU_SweepBOS_Demo |
...
{
   UseInputsAsParams();
   if(id==0) return true; // custom (manual params)
   switch(id)
   {
...
case 6: // MAPPING-> original 89 // NY_C31_RN40
               P.UseKillzones=true;
               P.KZ3s=1165;
               P.KZ3e=1185;
               P.KZ4s=1255;
...
case 11: // MAPPING-> original 107 // LDN_SHIFT_-10 (để chống 0 trade)
               P.UseKillzones=true;
               P.KZ1s=825;
               P.KZ1e=855;
               P.KZ2s=975;
...
case 15: // MAPPING-> original 76 // LDN_34_SHORT_SWING
               P.UseKillzones=true;
               P.KZ1s=835;
               P.KZ1e=900;
               P.UseRoundNumber=true;
...
case 16: // MAPPING-> original 102 // LDN_32_MICRO_RN37
               P.UseKillzones=true;
               P.KZ1s=835;
               P.KZ1e=865;
               P.KZ2s=985;
...
case 18: // MAPPING-> original 103 // LDN_34_BUFFER1_5
               P.UseKillzones=true;
               P.KZ1s=835;
               P.KZ1e=900;
               P.UseRoundNumber=true;
...
case 20: // MAPPING-> original 86 // NY_SHIFT_-10
               P.UseKillzones=true;
               P.KZ3s=1150;
               P.KZ3e=1180;
               P.KZ4s=1245;
...
case 21: // MAPPING-> original 84 // LDN_SHIFT_-15
               P.UseKillzones=true;
               P.KZ1s=820;
               P.KZ1e=850;
               P.KZ2s=970;
...
case 22: // MAPPING-> original 87 // NY_SHIFT_+10
               P.UseKillzones=true;
               P.KZ3s=1170;
               P.KZ3e=1200;
               P.KZ4s=1265;
