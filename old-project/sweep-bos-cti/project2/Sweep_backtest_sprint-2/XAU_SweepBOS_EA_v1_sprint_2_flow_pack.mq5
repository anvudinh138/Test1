   ...
   switch(id)
     {
      ...
      case 37:
         // Sprint2 BotB: ATR14x1.5 | StartRR=0.8 | Py(1,0.50,0.7)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 38:
         // Sprint2 BotB: STEP0.30 | StartRR=1.0 | BE0.8/PC50 | Py(2,0.45,0.6)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 39:
         // Sprint2 BotB: STEP0.35 | StartRR=1.0 | Py(2,0.40,0.7)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      //27–31 là winners Sprint 1, 32–39 là winners
      ...
      case 201:
         // Sprint2 BotA: ATR14x1.8 | BE1.0/TP1=1.2/PC30%
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 202:
         // Sprint2 BotA: ATR21x1.8 | BE0.9/TP1=1.3/PC35%
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 210:
         // Sprint2 BotB: STEP0.25 | StartRR=0.8 | Py(2,0.35,0.6)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 211:
         // Sprint2 BotB: STEP0.30 | StartRR=1.0 | Py(3,0.35,0.5)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 215:
         // Sprint2 BotB: STEP0.45 | StartRR=1.2 | BE1.0/PC30 | Py(1,0.45,0.6)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 216:
         // Sprint2 BotB: STEP0.25 | StartRR=0.8 | aggressive | Cooldown=0 | Py(2,0.30,0.5)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 217:
         // Sprint2 BotB: ATR14x1.4 | StartRR=0.8 | Py(2,0.35,0.6)
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 218:
         // Sprint2 BotB: STEP0.30 | StartRR=1.0 | Py(2,0.45,0.6) | MaxOpen=4
         P.UseKillzones=true;
         P.KZ1s=835;
         P.KZ1e=865;
         P.KZ3s=1160;
      ...
      case 220:
         ...
         P.UseKillzones=true;
         P.KZ1s=835;  P.KZ1e=865;   // LDN window
         P.KZ3s=1160; P.KZ3e=1185;  // NY window
      ...
      case 221:
         // Sprint2 BotB FT: STEP0.25 | StartRR=0.6 | BE0.6/TP1=1.0/PC50 | Py(2,0.35,0.6)
         P.UseKillzones=true;
         P.KZ1s=835;  P.KZ1e=865;   // LDN window
         P.KZ3s=1160; P.KZ3e=1185;  // NY window
         P.UseRoundNumber=true; P.RNDelta=0.35;
      ...
      case 224:
         // Sprint2 BotB FT: STEP0.20 | StartRR=0.6 | BE0.6/TP1=0.8/PC50 | Py(3,0.30,0.5) | micro-scalp
         P.UseKillzones=true;
         P.KZ1s=835;  P.KZ1e=865;   // LDN window
         P.KZ3s=1160; P.KZ3e=1185;  // NY window
         P.UseRoundNumber=true; P.RNDelta=0.35;
      ...
      case 227:
         // Sprint2 BotB FT: STEP0.30 | StartRR=0.8 | BE0.8/PC60 | Py(1,0.40,0.7)
         P.UseKillzones=true;
         P.KZ1s=835;  P.KZ1e=865;   // LDN window
         P.KZ3s=1160; P.KZ3e=1185;  // NY window
         P.UseRoundNumber=true; P.RNDelta=0.35;
      ...
      case 231:
         // Sprint2 BotB FT: STEP0.30 | StartRR=0.8 | BE0.8/TP1=1.2/PC40 | Py(2,0.35,0.6) | Cooldown=60
         P.UseKillzones=true;
         P.KZ1s=835;  P.KZ1e=865;   // LDN window
         P.KZ3s=1160; P.KZ3e=1185;  // NY window
         P.UseRoundNumber=true; P.RNDelta=0.35;
