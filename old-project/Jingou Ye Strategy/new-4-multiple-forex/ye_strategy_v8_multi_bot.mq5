//+------------------------------------------------------------------+
//|                                     ye_strategy_v8_multi_bot.mq5|
//|                                  Copyright 2024, Gemini Advisor  |
//|                    Version 8.0 (Multi-Symbol Multi-Bot)         |
//+------------------------------------------------------------------+
#property copyright "Copyright 2024, Gemini Advisor"
#property link      ""
#property version   "8.0"
#property description "Multi-symbol trading with preset bot configurations. Enhanced version of the single-symbol EA."
#property strict
...
// Bot presets based on optimization results
enum ENUM_BOT_PRESET 
{
    PRESET_NONE,
    PRESET_BOT_1,  // Pass 2426 - NZDUSD Optimized
    PRESET_BOT_2,  // Pass 4785 - GBPUSD Optimized  
    PRESET_BOT_3,  // Pass 1247 - EURUSD Optimized
    PRESET_BOT_4,  // Pass 835  - USDCAD Optimized
    PRESET_BOT_5,  // Pass 1017 - NZDUSD Alternative
    PRESET_BOT_6,  // Pass 612  - GBPUSD Alternative
    PRESET_BOT_7,  // Pass 1877 - EURUSD Alternative
    PRESET_BOT_8,  // Pass 349  - AUDUSD Optimized
    PRESET_BOT_9,  // Pass 196  - NZDUSD Conservative
    PRESET_BOT_10  // Pass 196  - GBPUSD Conservative
};

//--- EA Inputs ---

//--- SECTION: Multi-Symbol & Bot Presets ---
input string            InpSymbolsToTrade = "EURUSD,GBPUSD,AUDUSD,NZDUSD,USDCAD"; // Symbols to trade (comma separated)
input ENUM_BOT_PRESET   InpBotPreset = PRESET_NONE; // Select Bot Configuration
...
//+------------------------------------------------------------------+
//| Symbol Manager Class - Quản lý giao dịch cho từng cặp tiền      |
//+------------------------------------------------------------------+
...
int OnInit()
{
    Print("Initializing Multi-Symbol EA v8.0...");
    ...
    for(int i = 0; i < total_symbols; i++)
    {
        ...
        {
            if(symbol != "") Print("Error: Cannot select symbol '", symbol, "'.");
        }
    }
...
{
    Print("Deinitializing Multi-Symbol EA v8.0. Reason: ", (string)reason);
}
...
//+------------------------------------------------------------------+
//| Initialize parameters from preset or inputs                     |
//+------------------------------------------------------------------+
void InitializeParameters()
{
    switch(InpBotPreset)
    {
        case PRESET_BOT_1: // Profile=BOT1 | Symbol=NZDUSD | Pass=2426
            Print("Applying Preset: BOT 1 (Pass 2426 - NZDUSD Optimized)");
            g_FastEMA_Period = 9;
        ...
        case PRESET_BOT_2: // Profile=BOT1 | Symbol=GBPUSD | Pass=4785
            Print("Applying Preset: BOT 2 (Pass 4785 - GBPUSD Optimized)");
            g_FastEMA_Period = 9;
        ...
        case PRESET_BOT_3: // Profile=BOT1 | Symbol=EURUSD | Pass=1247
            Print("Applying Preset: BOT 3 (Pass 1247 - EURUSD Optimized)");
            g_FastEMA_Period = 9;
        ...
        case PRESET_BOT_4: // Profile=BOT2 | Symbol=USDCAD | Pass=835
            Print("Applying Preset: BOT 4 (Pass 835 - USDCAD Optimized)");
            g_FastEMA_Period = 9;
            g_Slow1EMA_Period = 28;
            g_Slow2EMA_Period = 50;
            g_StopLossPoints = 250;
        ...
        case PRESET_BOT_5: // Profile=BOT2 | Symbol=NZDUSD | Pass=1017
            Print("Applying Preset: BOT 5 (Pass 1017 - NZDUSD Alternative)");
            g_FastEMA_Period = 9;
            g_Slow1EMA_Period = 28;
            g_Slow2EMA_Period = 50;
            g_StopLossPoints = 250;
        ...
        case PRESET_BOT_6: // Profile=BOT2 | Symbol=GBPUSD | Pass=612
            Print("Applying Preset: BOT 6 (Pass 612 - GBPUSD Alternative)");
            g_FastEMA_Period = 10;
            g_Slow1EMA_Period = 30;
        ...
        case PRESET_BOT_7: // Profile=BOT2 | Symbol=EURUSD | Pass=1877
            Print("Applying Preset: BOT 7 (Pass 1877 - EURUSD Alternative)");
            g_FastEMA_Period = 9;
            g_Slow1EMA_Period = 28;
            g_Slow2EMA_Period = 50;
            g_StopLossPoints = 250;
        ...
        case PRESET_BOT_8: // Profile=BOT3 | Symbol=AUDUSD | Pass=349
            Print("Applying Preset: BOT 8 (Pass 349 - AUDUSD Optimized)");
            g_FastEMA_Period = 10;
            g_Slow1EMA_Period = 30;
            g_Slow2EMA_Period = 55;
        ...
        case PRESET_BOT_9: // Profile=BOT3 | Symbol=NZDUSD | Pass=196
            Print("Applying Preset: BOT 9 (Pass 196 - NZDUSD Conservative)");
            g_FastEMA_Period = 10;
            g_Slow1EMA_Period = 30;
            g_Slow2EMA_Period = 55;
            g_StopLossPoints = 300;
        ...
        case PRESET_BOT_10: // Profile=BOT3 | Symbol=GBPUSD | Pass=196
            Print("Applying Preset: BOT 10 (Pass 196 - GBPUSD Conservative)");
            g_FastEMA_Period = 9;
            g_Slow1EMA_Period = 28;
            g_Slow2EMA_Period = 54;
            g_StopLossPoints = 250;
...
void CSymbolManager::PlaceOrderSet(ENUM_ORDER_TYPE order_type, double entry_price = 0)
{
    ...
    string trade_set_comment = "JYS_v8.0_" + (string)TimeCurrent(); 
...
{ 
    ...
    string pt="--- Jinguo Ye Strategy v8.0 ---\n\n"; 
